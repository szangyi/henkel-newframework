...
var videoOpen  = document.querySelector('.video-open');
var videoClose = document.querySelector('.video-close');
var video      = document.querySelector('.video video');
if(video){
	//	video open
	videoOpen.addEventListener('click', open)
	...
	function close(){
		videoWP.classList.remove('open');
		videoWP.style.transform = '';
		videoWP.style.opacity = '';
		videoWP.style.pointerEvents = '';
		video.pause();
		video.currentTime = 0;
	}
}
